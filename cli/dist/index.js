...
import { NPMStatsAPI, formatNumber } from '@npm-stats-toolkit/shared';
...
function displayUserStats(stats, summaryOnly = false, showRankings = false, includeGitHub = false) {
    console.log(chalk.bold.green(`\\n📊 NPM Statistics for ${stats.username}`));
...
function displayPackageStats(packageName, downloads, info) {
    console.log(chalk.bold.green(`\\n📦 ${packageName}`));
    console.log(chalk.gray('='.repeat(50)));
...
function displayPackageHistory(packageName, history) {
